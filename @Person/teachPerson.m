...
%TEACHCARTESIAN Jog the robot using Cartesian coordinates
    ...
    self.to_h.sliderLimits = [... 
        ...
        0, 360]; 
    %-------------------------------
    InstallThePersonPanel(self);
    MakePersonSliders(self);
    CreatePersonPositionDisplay(self);
    CreatePersonOrientationDisplay(self);
    AddExitButtonPerson(self);
    AssignPersonCallbacks(self);
end

function teach_Personcallback(src, self, j)
...
function AssignPersonCallbacks(self)
    ...
    for j=1:n
        ...
        set(self.to_h.edit(j), ...
            'Interruptible', 'off', ...
            'Callback', @(src,event)teach_Personcallback(src, self, j));
...
function resize_Personcallback(self)
...
function AddExitButtonPerson(self)
    ...
    uicontrol(self.to_h.panel, 'Style', 'pushbutton', ...
        ...
        'FontSize', 0.7, ...
        'CallBack', @(src,event) quit_Personcallback(self), ...
        'BackgroundColor', 'white', ...
        'ForegroundColor', 'red', ...
        'String', 'X');
end

function CreatePersonOrientationDisplay(self)
...
function CreatePersonPositionDisplay(self)
...
function MakePersonSliders(self)
    %---- sliders
    % Create the sliders
    n = size(self.to_h.sliderLabels,2);
    for j=1:n
...
function InstallThePersonPanel(self)
    ...
    set(self.to_h.fig, 'ResizeFcn', @(src,event) resize_Personcallback(self));
end
