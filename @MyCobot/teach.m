...
function teach(myCobot, varargin)
    ...
    for j=1:numAxis
        ...
        % slider itself
        q(j) = max( qlim(j,1), min( qlim(j,2), q(j) ) ); % clip to range
        handles.slider(j) = uicontrol(panel2, 'Style', 'slider', ...
            'Units', 'normalized', ...
        ...
        % text box showing slider value, also editable
        handles.edit(j) = uicontrol(panel2, 'Style', 'edit', ...
            'Units', 'normalized', ...
    ...
    for j=1:numAxis
        ...
        % slider itself
        q(j) = max( qlim(j,1), min( qlim(j,2), q(j) ) ); % clip to range
        handles.slider(j) = uicontrol(panel3, 'Style', 'slider', ...
            'Units', 'normalized', ...
            'Position', [0.15 height*2*(numAxis-j+2) 0.65 height*2], ...
            'Min', qlim(j,1), ...
            'Max', qlim(j,2), ...
        ...
        % text box showing slider value, also editable
        handles.edit(j) = uicontrol(panel3, 'Style', 'edit', ...
            'Units', 'normalized', ...
            'Position', [0.80 height*2*(numAxis-j+2)+.01 0.20 0.9*height*2], ...
            'BackgroundColor', bgcol, ...
            'String', num2str(qscale(j)*q(j), 3), ...
