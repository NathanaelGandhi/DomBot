...
%TEACHCARTESIAN Jog the robot using Cartesian coordinates
    ...
    handles = CreateOrientationDisplay(handles);
    handles = AddExitButton(handles);
    handles = AssignCallbacks(handles);
end

function handles = CreateOrientationDisplay(handles)
 %---- set up the orientation display box
    ...
    handles.t6.r(1) = uicontrol(handles.panel, 'Style', 'text', ...
        'Units', 'normalized', ...
    ...
    handles.t6.r(2) = uicontrol(handles.panel, 'Style', 'text', ...
        'Units', 'normalized', ...
    ...
    handles.t6.r(3) = uicontrol(handles.panel, 'Style', 'text', ...
        'Units', 'normalized', ...
